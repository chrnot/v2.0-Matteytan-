    ...
    <div className="fixed inset-0 z-[3000] flex items-center justify-center p-4 sm:p-6 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-[var(--surface-primary)] w-full max-w-2xl max-h-[90vh] rounded-[2rem] shadow-2xl overflow-hidden flex flex-col animate-in zoom-in-95 duration-300 border border-[var(--sidebar-border)]">
        <div className="p-6 sm:p-8 overflow-y-auto custom-scrollbar text-[var(--text-main)]">
          ...
          <div className="space-y-6 opacity-80 leading-relaxed">
            <div className="bg-indigo-500/10 p-6 rounded-2xl border border-indigo-500/20">
              <h3 className="text-lg font-black text-indigo-500 mb-2">Välkommen!</h3>
            ...
            <section className="bg-rose-500/10 p-6 rounded-2xl border border-rose-500/20">
              <h3 className="text-sm font-black text-rose-500 uppercase tracking-widest mb-3">Nolltolerans</h3>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-sm font-bold text-rose-500/70">
                <li>• Våldsamma hot</li>
            ...
            <section className="bg-[var(--brand-secondary)] p-6 rounded-2xl border border-[var(--sidebar-border)]">
              <h3 className="text-sm font-black text-[var(--text-main)] uppercase tracking-widest mb-2 opacity-70">Konsekvenser</h3>
        ...
        <div className="bg-[var(--brand-secondary)] p-4 border-t border-[var(--sidebar-border)] flex justify-center">
          <button 
            onClick={onClose}
            className="px-8 py-3 bg-indigo-600 text-white rounded-full font-black text-sm shadow-lg hover:bg-indigo-700 transition-all shadow-indigo-500/20 active:scale-95"
          >
            JAG ACCEPTERAR
          </button>
        </div>
